...
**Alt + Insert**: 这个不仅适用于工作区，还适用于**项目树处新创建文件**。
...
|--------------- | --------------- |
| Alt + 1   | 快速打开/关闭项目树   |
| Ctrl + F4   | 关闭当前标签页, 工作区和终端都适用   |
| Alt + 4   | 打开构建窗口   |
| Alt + F12   | 打开终端界面   |
| Alt + 左箭头/右箭头   | 左右切换标签页   |
| Ctrl + Shift + t   | 终端处新加一个标签页   |

**Alt + 左箭头/右箭头**: 上面提到的这个左右切换标签页其实涉及到工作区处还有终端处，统一适用这个快捷键。
